...
?>
        ...
        <div class="buttons">
            ...
            <button type="button" onclick="saved = save(); console.log(saved);">SAVE</button>
    ...
    <script>
        ...
        function save() {
            var classic = document.getElementById("classicImage").src;
            var stinger = document.getElementById("stingerImage").src;
            var bulldog = document.getElementById("bulldogImage").src;
            var marshal = document.getElementById("marshalImage").src;
            var shorty = document.getElementById("shortyImage").src;
            var spectre = document.getElementById("spectreImage").src;
            var guardian = document.getElementById("guardianImage").src;
            var operator = document.getElementById("operatorImage").src;
            var frenzy = document.getElementById("frenzyImage").src;
            var bucky = document.getElementById("buckyImage").src;
            var phantom = document.getElementById("phantomImage").src;
            var ares = document.getElementById("aresImage").src;
            var ghost = document.getElementById("ghostImage").src;
            var judge = document.getElementById("judgeImage").src;
            var vandal = document.getElementById("vandalImage").src;
            var odin = document.getElementById("odinImage").src;
            var sheriff = document.getElementById("sheriffImage").src;
            var melee = document.getElementById("meleeImage").src;

            return [classic, stinger, bulldog, marshal, shorty, spectre, guardian, operator, frenzy, bucky, phantom, ares, ghost, judge, vandal, odin, sheriff, melee];
        }

        function load() {
            //x = save number selected
            console.log("Loaded from save.");
            $('#classicImage').attr("src", saved[0]);
            $('#stingerImage').attr("src", saved[1]);
            $('#bulldogImage').attr("src", saved[2]);
            $('#marshalImage').attr("src", saved[3]);
            $('#shortyImage').attr("src", saved[4]);
            $('#spectreImage').attr("src", saved[5]);
            $('#guardianImage').attr("src", saved[6]);
            $('#operatorImage').attr("src", saved[7]);
            $('#frenzyImage').attr("src", saved[8]);
            $('#buckyImage').attr("src", saved[9]);
            $('#phantomImage').attr("src", saved[10]);
            $('#aresImage').attr("src", saved[11]);
            $('#ghostImage').attr("src", saved[12]);
            $('#judgeImage').attr("src", saved[13]);
            $('#vandalImage').attr("src", saved[14]);
            $('#odinImage').attr("src", saved[15]);
            $('#sheriffImage').attr("src", saved[16]);
            $('#meleeImage').attr("src", saved[17]);
        }
